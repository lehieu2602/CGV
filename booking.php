...
<body>
    <div class="theaterMap">
        ...
        while ($row_ticketInfo = mysqli_fetch_array($sql_ticketInfo)) {
            $_SESSION['theaterName'] = $row_ticketInfo['id'];
            ...
            <div class="rowSeat">
                ...
                ?>
                    <form action="" method="post" class="seatName" style="display: inline;margin: 0">
                        ...
                        <button style="margin: 0;border: 0" type="submit" class="<?php if ($row_seat['seat_status'] == 1) echo "reserved disabled";
                                                                                    else echo "seats" ?> noselect" name="submit"><?php echo $row_seat['seat_name'] ?></button>
                    </form>
                    <!--        <div class="--><?php //if($row_seat['seat_status'] == 1) echo "reserved"; else echo "seats"
                                                ?><!-- noselect">--><?php //echo $row_seat['seat_name']
                                                                    ?><!--</div>-->
                <?php } ?>
            </div>
        <?php
