    ...
    <div class="login-signup" style="max-width: 500px;
        ...
        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist" style=" margin-bottom: 2%; background-color: #EE2C2C">
            <li class="nav-item" role="presentation">
                <div class="nav-link active" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true" style="border-bottom: 3px solid #fff;color: #fff;background-color: red;font-weight: 700;font-size: 17px;">
                    Đăng Nhập</div>
            </li>
            <li class="nav-item" role="presentation">
                <div class="nav-link" id="signup-tab" data-toggle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="false" style="border-bottom: 3px solid #fff;color: #fff;background-color: red;font-weight: 700;font-size: 17px;">
                    Đăng Kí</div>
            </li>
                ...
                <div class="cgvfc form-login-content">
                    <form action="" class="cgv-login-form" method="post" id="cgv-login-form">
                        <div class="form-group" style="margin-left: 5%;">
                            ...
                            <input type="email" id="emailUser" name="emailUser" class="form-control" placeholder="Email của bạn" style="width: 96%;">
                ...
                <form action="" class="cgv-signup-form" method="post" id="cgv-signup-form">
                    ...
                    <div class="terms-register">
                        <label class="r-terms" style="font-size: 13px;font-family: Verdana, Arial, sans-serif;font-weight: 600; text-transform: none;">
                            ...
                            <a href style="color: #e71a0f;text-decoration: none; font-family: Verdana, Arial, sans-serif; font-size:13px;">Quyền
                                lợi thành viên</a>
                            <br>
                            <input type="checkbox" checked="checked" name="cgv-terms" id="cgv-terms" value="ok" onchange="validateForm(this.id,termsdob)">
                            Tôi đồng ý với
                            <a href style="color: #e71a0f;text-decoration: none; font-family: Verdana, Arial, sans-serif; font-size:13px;">Điều
                                khoản Sử dụng của CGV</a>
                        </label>
                        <button type="submit" name="register" id="register" class="btn btn-danger" style="width: 100%;background-color: #e71a0f;color: white;padding: 14px 20px;margin: 8px 0;border: none;border-radius: 4px;cursor: pointer;text-transform: uppercase;">Đăng
                            Ký</button>
                    </div>
