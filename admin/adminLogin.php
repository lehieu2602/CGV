...
if (isset($_POST['adminLoginSubmit'])) {
    $username = $_POST['inputAccount'];
    $password = md5($_POST['inputPasswordLogin']);
    $sql_loginAdmin = mysqli_query($mysqli, "SELECT * FROM `admin` WHERE `user` = '$username' and `password` = '$password'");
    ...
    <div class="card shadow">
        <div class="card-body">
            <form class="form-signin" method="post">
                ...
                <label for="inputAccount" class="sr-only">Tài Khoản/Email</label>
                <input type="text" id="inputAccount" name="inputAccount" class="form-control" placeholder="Tài Khoản" required="" autofocus="">
                ...
                <p class="mt-5 mb-3 text-muted">HUS 2023-2024</p>
            </form>
        </div>
    </div>
</body>
